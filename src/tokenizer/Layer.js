...
export default class Layer {
  ...
  recalculateMask() {
    if (this.sourceMask && !this.customMask) {
      const context = this.sourceMask.getContext('2d');
  ...
  redraw() {
    ...
    originalContext.clearRect(0, 0, this.source.width, this.source.height);
    originalContext.translate(this.center.x, this.center.y);
    originalContext.scale(this.mirror * 1, 1);
    originalContext.rotate(this.rotation * CONSTANTS.TO_RADIANS);
    originalContext.translate(-this.center.x, -this.center.y);
    originalContext.globalAlpha = this.alpha;
